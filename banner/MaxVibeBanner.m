...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"Чужие Removed→❌ update · свои delete без хуков" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
