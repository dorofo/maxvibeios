...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"DELETE→UPDATE с ❌ (как deletel на Android)" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
