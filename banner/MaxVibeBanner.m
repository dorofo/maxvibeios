...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v16: ❌ сразу в чате · без мигания при входе" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
