...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v10: только push keep · без хуков UI (без вылета)" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
