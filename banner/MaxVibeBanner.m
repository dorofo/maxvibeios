...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v13: без _messagesUpdated (без вылета) · keep+❌" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
