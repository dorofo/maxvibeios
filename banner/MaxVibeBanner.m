...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v12: UI-хук C-trampoline · полный msg из Yap + ❌" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
