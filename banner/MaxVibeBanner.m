...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"Чужие delete→UPDATE с ❌ · свои без хуков" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
