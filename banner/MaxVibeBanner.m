...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v14.2: keep+❌ · меньше мигания" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
