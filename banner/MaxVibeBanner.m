...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v14.3: ❌ сразу · delayed UI hook" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
