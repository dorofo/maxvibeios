...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"Чужие delete→UPDATE ❌ + сброс Removed · свои как обычно" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
