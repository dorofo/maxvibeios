...
- (void)showSettings {
    ...
    [stack addArrangedSubview:[self settingsRowTitle:MaxVibeAntiDeleteEnabled() ? @"Антиудаление: включено" : @"Антиудаление: выключено" subtitle:@"v14.1: keep+❌ · без мигания при входе" action:@selector(onSettingsToggleAntiDelete) chevron:NO]];
